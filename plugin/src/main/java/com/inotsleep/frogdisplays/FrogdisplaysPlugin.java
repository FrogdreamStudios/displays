...
import com.inotsleep.frogdisplays.commands.DisplayCommand;
import com.inotsleep.frogdisplays.listeners.SelectionListener;
import com.inotsleep.frogdisplays.listeners.PlayerListener;
import com.inotsleep.frogdisplays.managers.DisplayManager;
import com.inotsleep.frogdisplays.storage.Storage;
import com.inotsleep.frogdisplays.utils.GithubReleaseFetcher;
import com.inotsleep.frogdisplays.utils.net.PacketReceiver;
...
public final class FrogdisplaysPlugin extends AbstractPlugin<FrogdisplaysPlugin> {
    ...
    public static FrogdisplaysPlugin getInstance() {
        return getInstanceByClazz(FrogdisplaysPlugin.class);
    }
