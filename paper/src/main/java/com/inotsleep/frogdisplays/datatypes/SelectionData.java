...
import com.inotsleep.frogdisplays.utils.ParticleUtil;
...
public class SelectionData {
    ...
    public void drawBox() {
        ...
        ParticleUtil.drawRectangleOnFace(player, pos1, pos2, face, FrogdisplaysPlugin.config.settings.particlesPerBlock, Color.fromRGB(FrogdisplaysPlugin.config.settings.particlesColor));
    }
